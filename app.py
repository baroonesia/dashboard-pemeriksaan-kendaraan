...
if check_login():
    ...
    if selected == "Input Pemeriksaan":
        ...
        with st.container():
            ...
            with c3: st.caption("Isi Kilometer terbaru pada dashboard kendaraan.");
            km = st.number_input("KM", min_value=, step=1, label_visibility="collapsed", placeholder="Isi KM Dashboard", help="Silakan masukkan angka kilometer terbaru yang tertera pada dashboard kendaraan.")
