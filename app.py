    ...
    if selected == "Input Pemeriksaan":
        ...
        with st.container():
            ...
            with c2:
                ...
                with c3: 
                st.caption("Input Kilometer")
                km = st.number_input("KM", value=None, min_value=0, step=1, label_visibility="collapsed", placeholder="Isi KM Dashboard", help="Silakan masukkan angka kilometer terbaru yang tertera pada dashboard kendaraan.")
            with c4:
